...
function Practice(props) {
  ...
  const mapper = (aProfile) => {
    return <VetList key={"vet-list-id" + aProfile.id} profile={aProfile} />;
  };
          ...
          <div className="col xl-7 lg-7 md-12 sm-12">
            <div>
              <div className="d-md-flex align-items-center justify-content-between">
                ...
                <button
                  className="practice-btn btn btn-primary practice-btn-primary mb-2"
              ...
              <h2 className="text-white mb-2 lead">
                {" "}
                {state.location.lineOne} {state.location.lineTwo}
              </h2>
              <h2 className="text-white mb-3 lead">{state.location.city}</h2>
              <h3 className="text-white mb-3 lead">
                Phone: {state.phone} Fax: {state.fax}
              </h3>
            </div>
          </div>
        </div>
              ...
              <Tab.Container defaultActiveKey={"description"}>
                <Card>
                  <Nav className="nav-lb-tab">
                    {["Description", "Location", "Vets", "Services"].map(
                      (item, index) => (
                        <Nav.Item key={index}>
                          <Nav.Link
                    ...
                    <Tab.Content>
                      ...
                      >
                        ...
                        <Card className="border-0">
                          ...
                          <Card.Body>{state.description}</Card.Body>
                        </Card>
                      </Tab.Pane>
                        ...
                        <Card className="border-0">
                          <Card.Header>
                            <div className="mb-3 mb-lg-0">
                              ...
                              <p className="mb-0">Map of {state.name}</p>
                            </div>
                          </Card.Header>
                          <PracticeMap
                            latlng={center}
            ...
            <Col lg={4} md={12} sm={12} className="mt-lg-n22">
              ...
              <Card className="mb-3 mb-4">
                <div className="single-practice-img d-flex justify-content-center position-relative rounded border-white border rounded-3 bg-cover">
                  <Card.Img variant="top" src={state.primaryImage[0].url} />
                </div>
                {/* Card body */}
                <Card.Body>
                  <div className="mb-3">
                    <p className="mb-0">Email : </p>
                    <span className="text-dark fw-bold h6 me-2">
                      {state.businessEmail}
                    </span>
                  </div>
                  <div className="mb-3">
